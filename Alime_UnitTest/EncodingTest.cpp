...
//		auto fs = new Alime::base::System::IO::FileStream(L"./fuckyouU16.txt", Alime::base::FileMode::Append, Alime::base::FileAccess::ReadWrite);
//		Alime::base::System::IO::Utf16Encoder encoder;
//		encoder.Setup(fs);
...
//		decoder.Setup(fs2);
//		wchar_t buf[1024];
//		auto nRead = decoder.Read(buf, 1024);//这里的测试是为了跳过bom
//		//buf[nRead] = L'\0';
//		std::wstring str;
